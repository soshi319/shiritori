export function RuleView() {
  return (
    <div className="flex flex-col gap-4">
      ...
      <section>
        {/* 見出しの色をインディゴ系に変更（読みやすい濃さ） */}
        <h3 className="font-bold text-indigo-700 mb-1">基本ルール</h3>
        {/* 文字色を読みやすいダークグレーに */}
      ...
      <section>
        <h3 className="font-bold text-indigo-700 mb-1">ダメージについて</h3>
        <p className="text-sm text-stone-700">
      ...
      <section>
        <h3 className="font-bold text-indigo-700 mb-1">反射（カウンター）</h3>
        <p className="text-sm text-stone-700">
      ...
      <section>
        <h3 className="font-bold text-indigo-700 mb-1">キャラクター</h3>
        <p className="text-sm text-stone-700">
